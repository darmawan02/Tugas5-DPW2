...
<div class="body-wrapper">
        ...
        <div class="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-white">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="site-logo">
                            <a href="index.html"><img src="{{url('public/assets')}}/img/logo_jam.jpeg" alt="Logo" height="40"></a>
                        </div>
                    </div>
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="{{url('public/assets')}}/img/logo.png" alt="Logo"></a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-7 col-sm-7 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner  ltn__slide-animation">
                                        ...
                                        <h1 class="slide-title animated">Watch Shop <br>Darmawan </h1>
                                        <div class="slide-brief animated">
                                            <p>"Ayo beli produk kami karna yang lain belum tentu berkualitas."</p>
                                        </div>
                            ...
                            <div class="col-lg-6 col-md-5 col-sm-5 align-self-center">
                                <div class="slide-item-img">
                                    <a href="shop.html"><img src="{{url('public/assets')}}/img/slider/mawan.png" alt="Image"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ltn__slide-item-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-5 col-sm-5 align-self-center">
                                <div class="slide-item-img">
                                    <a href="shop.html"><img src="{{url('public/assets')}}/img/slider/mawan1.png" alt="Image"></a>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-7 col-sm-7 align-self-center">
                                <div class="slide-item-info">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        ...
                                        <h1 class="slide-title animated">Watch Shop <br> Darmawan</h1>
                                        <div class="slide-brief animated">
                                            <p>"Segera kumpulkan koleksi terbarunya! Persedian Terbatas."</p>
                                        </div>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">Shop now</a>
                                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title ">Bayangkan!</h1>
                        <p>Kenakan jam tangan ini akan buatmu seperti superstar! </p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{url('public/assets')}}/img/product-2/a.jpeg" alt="#"></a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{url('public/assets')}}/img/product-2/b.jpeg" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                                </ul>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{url('public/assets')}}/img/product-2/c.jpg" alt="#"></a>
                            <div class="product-badge">
                                <ul>
                                    <li class="sale-badge">New</li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                        <div class="footer-widget footer-newsletter-widget">
                            ...
                            <img src="{{url('public/assets')}}/img/icons/payment-4.png" alt="Payment Image">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="{{url('public/assets')}}/img/product/4.png" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="{{url('public/assets')}}/img/product/1.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                         ...
                                         <div class="additional-info d-none">
                                            ...
                                            <div class="payment-method">
                                                <img src="{{url('public/assets')}}/img/icons/payment.png" alt="#">
                                            </div>
                                         </div>
                                    </div>
                                </div>
                         ...
                         <div class="ltn__quick-view-modal-inner">
                             <div class="modal-product-item">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                            <img src="{{url('public/assets')}}/img/product/7.png" alt="#">
                                        </div>
                                         <div class="modal-product-info">
                                            <h5><a href="product-details.html">Brand new product</a></h5>
